...
pub const unit_helper = struct {
    ...
    pub const rad_0: f128 = deg_0 * deg_to_rad; //warning stick with f128, math.sinh etc
    pub const rad_20: f128 = deg_20 * deg_to_rad;
    pub const rad_30: f128 = deg_30 * deg_to_rad;
    pub const rad_45: f128 = deg_45 * deg_to_rad;
    pub const rad_60: f128 = deg_60 * deg_to_rad;
    pub const rad_90: f128 = deg_90 * deg_to_rad;
    ...
    pub const tan_90 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const tan_neg_90 = angle.AngleF32.neg_inf; // warning stick with f128, gamedev related

    pub const cot_0 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const cot_neg_0 = angle.AngleF32.neg_inf; // warning stick with f128, gamedev related
    ...
    pub const sec_90 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const sec_neg_90 = angle.AngleF32.inf; // warning stick with f128, gamedev related

    pub const csc_0 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const csc_neg_0 = angle.AngleF32.neg_inf; // warning stick with f128, gamedev related
    ...
    pub const coth_0 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const coth_neg_0 = angle.AngleF32.neg_inf; // warning stick with f128, gamedev related
    ...
    pub const csch_0 = angle.AngleF32.inf; // warning stick with f128, gamedev related
    ...
    pub const csch_neg_0 = angle.AngleF32.neg_inf; // warning stick with f128, gamedev related
