...
pub fn unit_helper(comptime T: type) type {
    return struct {
        ...
        pub const rad_0 = deg_0 * deg_to_rad; //warning stick with f128, math.sinh etc
        ...
        pub const tan_90 = angle.inf; // warning stick with f128, gamedev related
        ...
        pub const tan_neg_90 = angle.neg_inf; // warning stick with f128, gamedev related

        pub const cot_0 = angle.inf; // warning stick with f128, gamedev related
        ...
        pub const cot_neg_0 = angle.neg_inf; // warning stick with f128, gamedev related
        ...
        pub const sec_90 = angle.inf; // warning stick with f128, gamedev related
        ...
        pub const sec_neg_90 = angle.inf; // warning stick with f128, gamedev related

        pub const csc_0 = angle.inf; // warning stick with f128, gamedev related
        ...
        pub const csc_neg_0 = angle.neg_inf; // warning stick with f128, gamedev related
        ...
        pub const sinh_0 = angle.sinh_of_rad(rad_0);
        pub const sinh_20 = angle.sinh_of_rad(rad_20);
        pub const sinh_30 = angle.sinh_of_rad(rad_30);
        pub const sinh_45 = angle.sinh_of_rad(rad_45);
        pub const sinh_60 = angle.sinh_of_rad(rad_60);
        pub const sinh_90 = angle.sinh_of_rad(rad_90);

        pub const sinh_neg_0 = angle.sinh_of_rad(neg_rad_0);
        pub const sinh_neg_20 = angle.sinh_of_rad(neg_rad_20);
        pub const sinh_neg_30 = angle.sinh_of_rad(neg_rad_30);
        pub const sinh_neg_45 = angle.sinh_of_rad(neg_rad_45);
        pub const sinh_neg_60 = angle.sinh_of_rad(neg_rad_60);
        pub const sinh_neg_90 = angle.sinh_of_rad(neg_rad_90);

        pub const cosh_0 = angle.cosh_of_rad(rad_0);
        pub const cosh_20 = angle.cosh_of_rad(rad_20);
        pub const cosh_30 = angle.cosh_of_rad(rad_30);
        pub const cosh_45 = angle.cosh_of_rad(rad_45);
        pub const cosh_60 = angle.cosh_of_rad(rad_60);
        pub const cosh_90 = angle.cosh_of_rad(rad_90);

        pub const cosh_neg_0 = angle.cosh_of_rad(neg_rad_0);
        pub const cosh_neg_20 = angle.cosh_of_rad(neg_rad_20);
        pub const cosh_neg_30 = angle.cosh_of_rad(neg_rad_30);
        pub const cosh_neg_45 = angle.cosh_of_rad(neg_rad_45);
        pub const cosh_neg_60 = angle.cosh_of_rad(neg_rad_60);
        pub const cosh_neg_90 = angle.cosh_of_rad(neg_rad_90);

        pub const tanh_0 = angle.tanh_of_rad(rad_0);
        pub const tanh_20 = angle.tanh_of_rad(rad_20);
        pub const tanh_30 = angle.tanh_of_rad(rad_30);
        pub const tanh_45 = angle.tanh_of_rad(rad_45);
        pub const tanh_60 = angle.tanh_of_rad(rad_60);
        pub const tanh_90 = angle.tanh_of_rad(rad_90);

        pub const tanh_neg_0 = angle.tanh_of_rad(neg_rad_0);
        pub const tanh_neg_20 = angle.tanh_of_rad(neg_rad_20);
        pub const tanh_neg_30 = angle.tanh_of_rad(neg_rad_30);
        pub const tanh_neg_45 = angle.tanh_of_rad(neg_rad_45);
        pub const tanh_neg_60 = angle.tanh_of_rad(neg_rad_60);
        pub const tanh_neg_90 = angle.tanh_of_rad(neg_rad_90);

        pub const coth_0 = angle.inf; // warning stick with f128, gamedev related
        pub const coth_20 = 1.0 / angle.tanh_of_rad(rad_20);
        pub const coth_30 = 1.0 / angle.tanh_of_rad(rad_30);
        pub const coth_45 = 1.0 / angle.tanh_of_rad(rad_45);
        pub const coth_60 = 1.0 / angle.tanh_of_rad(rad_60);
        pub const coth_90 = 1.0 / angle.tanh_of_rad(rad_90);

        pub const coth_neg_0 = angle.neg_inf; // warning stick with f128, gamedev related
        pub const coth_neg_20 = 1.0 / angle.tanh_of_rad(neg_rad_20);
        pub const coth_neg_30 = 1.0 / angle.tanh_of_rad(neg_rad_30);
        pub const coth_neg_45 = 1.0 / angle.tanh_of_rad(neg_rad_45);
        pub const coth_neg_60 = 1.0 / angle.tanh_of_rad(neg_rad_60);
        pub const coth_neg_90 = 1.0 / angle.tanh_of_rad(neg_rad_90);

        pub const sech_0 = 1.0 / angle.cosh_of_rad(rad_0);
        pub const sech_20 = 1.0 / angle.cosh_of_rad(rad_20);
        pub const sech_30 = 1.0 / angle.cosh_of_rad(rad_30);
        pub const sech_45 = 1.0 / angle.cosh_of_rad(rad_45);
        pub const sech_60 = 1.0 / angle.cosh_of_rad(rad_60);
        pub const sech_90 = 1.0 / angle.cosh_of_rad(rad_90);

        pub const sech_neg_0 = 1.0 / angle.cosh_of_rad(neg_rad_0);
        pub const sech_neg_20 = 1.0 / angle.cosh_of_rad(neg_rad_20);
        pub const sech_neg_30 = 1.0 / angle.cosh_of_rad(neg_rad_30);
        pub const sech_neg_45 = 1.0 / angle.cosh_of_rad(neg_rad_45);
        pub const sech_neg_60 = 1.0 / angle.cosh_of_rad(neg_rad_60);
        pub const sech_neg_90 = 1.0 / angle.cosh_of_rad(neg_rad_90);

        pub const csch_0 = angle.inf; // warning stick with f128, gamedev related
        pub const csch_20 = 1.0 / angle.sinh_of_rad(rad_20);
        pub const csch_30 = 1.0 / angle.sinh_of_rad(rad_30);
        pub const csch_45 = 1.0 / angle.sinh_of_rad(rad_45);
        pub const csch_60 = 1.0 / angle.sinh_of_rad(rad_60);
        pub const csch_90 = 1.0 / angle.sinh_of_rad(rad_90);

        pub const csch_neg_0 = angle.neg_inf; // warning stick with f128, gamedev related
        pub const csch_neg_20 = 1.0 / angle.sinh_of_rad(neg_rad_20);
        pub const csch_neg_30 = 1.0 / angle.sinh_of_rad(neg_rad_30);
        pub const csch_neg_45 = 1.0 / angle.sinh_of_rad(neg_rad_45);
        pub const csch_neg_60 = 1.0 / angle.sinh_of_rad(neg_rad_60);
        pub const csch_neg_90 = 1.0 / angle.sinh_of_rad(neg_rad_90);
