...
pub const cases = [_]TestCase{
    ...
    .{ .in_value = uh.sech_0, .out_unit = .none, .outarr = .{uh.rad_0} },
    ...
    .{ .in_value = uh.sech_20, .out_unit = .none, .outarr = .{uh.rad_20} },
    ...
    .{ .in_value = uh.sech_30, .out_unit = .none, .outarr = .{uh.rad_30} },
    ...
    .{ .in_value = uh.sech_45, .out_unit = .none, .outarr = .{uh.rad_45} },
    ...
    .{ .in_value = uh.sech_60, .out_unit = .none, .outarr = .{uh.rad_60} },
    ...
    .{ .in_value = uh.sech_90, .out_unit = .none, .outarr = .{uh.rad_90} },
    ...
    .{ .in_value = uh.sech_neg_0, .out_unit = .none, .outarr = .{uh.rad_0} },
    ...
    .{ .in_value = uh.sech_neg_20, .out_unit = .none, .outarr = .{uh.rad_20} },
    ...
    .{ .in_value = uh.sech_neg_30, .out_unit = .none, .outarr = .{uh.rad_30} },
    ...
    .{ .in_value = uh.sech_neg_45, .out_unit = .none, .outarr = .{uh.rad_45} },
    ...
    .{ .in_value = uh.sech_neg_60, .out_unit = .none, .outarr = .{uh.rad_60} },
    ...
    .{ .in_value = uh.sech_neg_90, .out_unit = .none, .outarr = .{uh.rad_90} },
