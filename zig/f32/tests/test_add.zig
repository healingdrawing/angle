...
pub fn test_add(comptime T: type, epsilon: T) !report.MethodResult {
    ...
    for (data_add.cases(T)) |tcase| {
        ...
        // Call TS bridge
        const data_str = try floatUtils.vectors_to_string(T, allocator, .{ @intFromEnum(tcase.in_unit), tcase.in_value, @intFromEnum(tcase.add_unit), tcase.add_value, @intFromEnum(tcase.out_unit) });
