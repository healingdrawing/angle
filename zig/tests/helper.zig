...
pub const unit_helper = struct {
    ...
    pub const coth_0 = angle.AngleF32.inf; // warning stick with f32, gamedev related
    ...
    pub const coth_neg_0 = angle.AngleF32.neg_inf; // warning stick with f32, gamedev related
